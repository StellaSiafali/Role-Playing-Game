...
### Σας παρουσιάζω το ψηφιακό παιχνίδι που δημιούργησα στα πλαίσια του μαθήματος "Ψηφιακά Παιχνίδια". Έπειτα από σκληρή δουλεία και πολύωρη ασχολία κατάφερα να το ολοκληρώσω έτσι όπως το ήθελα. Πρόκειται για ένα παιχνίδι μυστηρίου.
 
# Summary

### Το παιχνίδι μου είναι ένα παιχνίδι μυστηρίου - κινηγιού. Δραστηροποιείται την νύχτα. Ο παίκτης μου είναι ένας νίντζα ο οποίος προστατεύει ένα αρχαίο, πολύτιμο σπίτι της Ιαπωνίας. Καθώς λοιπόν, αποφάσισε για μία στιγμή να βγει εκτός σπιτιού να τσεκάρει μία δουλεία, όταν επέστρεψε είδε κάτι που δεν του άρεσε καθόλου. Είχαν εισβάλει μέσα στο σπίτι μία ομάδα από εχθρούς με πολύ κακές διαθέσεις, αποφασισμένοι να σκοτώσουν τον παίκτη μου και να κλέψουν οτιδήποτε πολύτιμο βρισκότανε μέσα. Όμως, ο νίντζα μου δεν θα το άφηνε έτσι αυτό. Το θέμα το παιχνιδιού μου είναι να καταφέρει ο νίντζα να σκοτώσει όλους τους εχθρούς και να μην τους επιτρέψει να κλέψουν κάτι από το σπίτι, εκτελώντας το χρέος του, που είναι η προστασία του πολύτιμού αυτού σπιτιού.
...
#### Ολοκληρώνας και το 3ο παραδοτεό κινήθηκα στο το ίδιο μοτίβο διάβασα τις οδηγίες, βεβαιώθηκα πως τις έχω κατανοήσει πλήρως και προχώρησα στην υλοποίηση του.

Ακολούθησα το tutorial που βρισκόταν στις οδηγίες προκειμένου να προσθέσω στον εχθρό μου "καπνό¨. Κατέβασα, λοιπόν, το sprite του "καπνού", πιο συγκεκριμένα επέλεξα μπλε λέιζερ, κάνοντας τις απαραίτητες αλλαγές σε πρόγραμμα και κώδικα σύμφωνα με τις οδηγίες βεβαιώθηκα ότι μου παίζει.

#### ***Ο "καπνός" - μπλε λέιζερ του εχθρού μου:***
|                                        |                                        |
|:-----------------------------------------:|:----------------------------------------------------:|
|![pngwing com](https://user-images.githubusercontent.com/100956284/212314895-41b548fa-395b-47f6-8c03-6e16b5553177.png)|![Στιγμιότυπο οθόνης (353)](https://user-images.githubusercontent.com/100956284/212315028-26432b04-6dc7-4fca-be73-d6657c8dfede.png)|

Επόμενο στάδιο ήταν να προσθέσω στον παίχτη μου αυτή την φορά μία μπάρα ζωής. Ακολούθησα για άλλη μία φορά το tutorial από τις οδηγίες. Για την μπάρα ζωής κατέβασα ένα sprite με την μπάρα ταιριαστό με το παιχνίδι κου, προσθέτοντας φωτογραφία του παίκτη μου, όπου στην συνέχεια μορφοποίησα για να είναι ορθό το αποτέλεσμα. Κάνοντας τις απαραίτητες αλλαγές στους κώδικες, σύμφωνα με τις οδηγίες αποθηκεύοντας τες και δοκιμάζοντας να παίξω το παιχνίδι βεβαιώθηκα πως όλα ήταν σωστά. 
Σχτικά με την μπάρα ζωής: η μπάρα που έφτιαξα γεμίζει και αδειάζει σταδιακά. Όταν ξεκινάει το παιχνίδι ο παίκτης μου έχει φουλ ζωή, με την μπάρα να είναι πλήρως γεμάτη. Ερχόμενος όμως, σε επάφη με τον εχθρό, εάν δεν προλάβει να τον σκοτώσει και καταφέρει ο εχθρός να τον τραυματίσει χάνει λίγο μέρος της ζωής του, με την μπάρα να αδειάζει σταδιακά. Δεν τελειώνει όμως εκεί το παιχνίδι, ο παίκτη μου έχει την δυνατότητα να ξαναγεμίσει την μπάρα με ζωή αρκεί να μαζέψει ένα από τα χορταράκια που βρίσκονται διάσπαρτα στην σκηνή. Κάθε φορά, δηλαδή που θα χάνει ζωή θα μπορεί να την ξανακερδίσει πέρνοντας ένα χορταράκι.

#### ***Η μπάρα ζωής του παίκτη μου:***
|                                        |                                        |
|:-----------------------------------------:|:----------------------------------------------------:|
|![pngegg](https://user-images.githubusercontent.com/100956284/212315465-57562282-c388-4a90-8991-17c64cdf1851.png)|![Στιγμιότυπο οθόνης (346)](https://user-images.githubusercontent.com/100956284/212318121-16b6d616-37bd-426e-8273-603181d3db37.png)|

#### ***Μερικά στιγμιότηπα του παιχνιδιού με την μπάρα ζωής (γέμισμα - άδειασμα μπάρας + μάζεμα χόρτου για απόκτηση ζωής)***
|                                        |                                        |
|:-----------------------------------------:|:----------------------------------------------------:|
|![Στιγμιότυπο οθόνης (347)](https://user-images.githubusercontent.com/100956284/212316198-a7c90cd9-0644-4fe1-bd1a-3273e2ec0b84.png)|![Στιγμιότυπο οθόνης (348)](https://user-images.githubusercontent.com/100956284/212316271-0b1bd68d-e3ad-4a19-921b-0c41465d2400.png)|
![Στιγμιότυπο οθόνης (349)](https://user-images.githubusercontent.com/100956284/212316382-5aa5af6e-a6c1-480b-8eb0-8ea4acfb31b8.png)|![Στιγμιότυπο οθόνης (351)](https://user-images.githubusercontent.com/100956284/212316409-55577ac4-c34c-4207-b639-b2fa097de3e7.png)|

Για το Teleport βοηθήθηκα από το παρακάτω tutorial: <a href="https://www.youtube.com/watch?v=9JvZwMmEydQ">εδώ </a> . Στην ουσία όταν ο παίχτης μου φτάσει στην δεξιά μάυρη τρύπα σαν να πέφτει μέσα της και αυτόματα μεταφέρεται στην απέναντι αριστερά μαύρη τρύπα. Με αυτό τον τρόπο είναι σαν να 'μπλοφάρει" τον εχθρό και καταφέρνει και του ξεφύγει.

#### ***Video αποτύπωσης του Teleport***

https://user-images.githubusercontent.com/100956284/212317014-c0ba941e-8d16-4a3b-b5ce-de53f8acc0c4.mp4

Θέλοντας να κάνω το παιχνίδι μου πιο διαδραστικό και διασκεδαστικό αποφάσισα να προσθέσω ήχους και μελωδίες. Όπως, σε κάθε στάδιο, ακολούθησα τις οδηγίες που βρισκόντουσαν στο GitHub. Πρόσθεσα ένα τραγούδι, που μου ταίριαζε, να ακούγεται καθόλη την διάρκεια που κάποιος παίζζει το παιχνίδι. Επέλεξα ήχους για τον παίκτη μου όταν αυτός θα κερδίζει ζωή, θα πυροβολάει με τις μοβ σφαίρες του τον εχθρό, θα τραυματίζεται από τον εχθρό όταν μονομαχούν. Αλλά και για τον εχθρό όταν σκοτώνεται και τέλος όταν ο παίκτης μου πραγματοποιεί teleport. Επέλεξα μέσα πό μία μεγάλη γκάμα από το παρακάτω site: <a href= "https://freesound.org/"> εδώ </a>.

Φτάνοντας στην ολοκλήρωσει το παραδοτέου και κατ'επέκταση του παιχνιδιού μου το τελικό στάδιο ήταν η δημιουργία ένος αρχικού μενού. Το πραγματοποίησα ακολουθώντας το παρακάτω tutorial:  <a href="https://www.youtube.com/watch?v=zc8ac_qUXQY&t=646s">εδώ </a> . Για το αρχικό μενού έφτιαξα μία καινούργια σκηνή στο παιχνίδι μου, επέλεξα μια φωτογραφία που να ταιριάζει με το όλο concept την συνέχεια μορφοποιώντας αυτήν την σκηνή, αυτός που επιθυμεί να παίξει το παιχνίδι μου μπορεί να διαλέξει μεταξυ 2 επιπέδων και να πατήσει εάν επιθυμεί Quit. Το παιχνίδι μου εμφανίζεται πατώντας το Level1, πατώντας τα άλλα δύο δεν εμφανίζεται κάτι (δυστυχώς δεν κατάφερα να συνεχίσω).

#### ***Το menu του παιχνιδιού μου***

![Στιγμιότυπο οθόνης (354)](https://user-images.githubusercontent.com/100956284/212317957-9626da24-cc20-47c4-b6b2-72f5d21ebb8a.png)

# Conclusions

### Συμπερασματικά, έχοντας ολοκληρώσει όλα τα παραδοτέα και το ψηφιακό μου παιχνίδι έχω να προσθέσω ότι ήταν ένα αρκετά απαιτητική εργασία αλλά ενδιαφέρον. Είμαι ικανοποιημένη με το αποτέλεσμα και κυρίως την σκηνή που δημιούργησα και όλο το θέμα. Δεν κατάφερα να προχωρήσω το παιχνίδι μου στο επόμενο επίπεδο, προσθέτωντας μία επιπλέον σκηνή για το Level 2, ούτε μπόρεσα να στο μενού να ενεργοποιείσω το Quit για τον χρήστη μου όταν αυτός το πατάει. Παρόλα αυτά πρόκειται για ένα παιχνίδι που θεωρώ ότι έχει ιδιαίτερο ενδιαφέρον, όμορφα γραφικά, σκηνή, είναι απαιτητικό, δεν βαριέται ο χρήστης και του δημιουργεί ένα άνχος στο να κατφέρει να σκοτώσει όλους τους εχθρούς και να νικήσει.

# Sources

### Τα έχω προσθέσει παραπάνω στην αναφορά.
